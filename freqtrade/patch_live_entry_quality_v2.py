...
# ---------------------------------------------------------------------------
# 1) EXECUTION-TIME RR REVALIDATION
# A signal can be valid when generated and still become a bad trade if price
# runs before the MARKET BUY reaches Binance. Recheck live price immediately
# before execution and reject if remaining reward/risk is too small.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 2) SIDEWAYS MID OVERHEAT GUARD
# The UNI loss occurred in SIDEWAYS_COMPRESSION with a strong short-term score
# but 1m RSI already >72 and 4h breadth <0.50. In sideways conditions, require
# a genuine reset and at least neutral 4h breadth before allowing MID continuation.
# Strong-bull/weak-bull MID behavior is unchanged.
# ---------------------------------------------------------------------------
