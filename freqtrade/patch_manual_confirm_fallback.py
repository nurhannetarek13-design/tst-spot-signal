...
# dynamic_exit_v2/final build checks.
whipsaw_patch = Path('/freqtrade/user_data/patch_early_whipsaw_protection_v2.py')
if not whipsaw_patch.exists():
    raise SystemExit('manual-confirm fallback: whipsaw v2 patch missing from user_data')
