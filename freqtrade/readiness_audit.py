...
"SECURITY_HARDENING","SCHEMA_API_CONTRACTS","BASELINE_CONTROL","FALSE_DISCOVERY","STRATEGY_DEPENDENCY","HUMAN_EMERGENCY_CONTROLS","DEEP_SPOOFING_DETECTION"]
def audit(*, offsite_dr=False, live_factor_history=False, live_queue_telemetry=False, live_post_fill_telemetry=False, fee_fx_complete=False, live_l2_spoofing=False):
    ...
    if not live_l2_spoofing: status["DEEP_SPOOFING_DETECTION"]="PARTIAL"; reasons["DEEP_SPOOFING_DETECTION"]="LIVE_ORDER_BOOK_CANCELLATION_TELEMETRY_REQUIRED"
