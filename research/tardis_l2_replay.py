...
`pu` continuity, reconstructs L2 state, rejects crossed books, and checks exact
...
def replay_ordered_rows(
    ...
    *,
    ...
    for r in depth_rows:
        ...
        replay_by_u[u] = {
            "bid": _pair(bid_p, bid_q),
            "ask": _pair(ask_p, ask_q),
        }
