...
for need in ['handleFastSignalIngest','/fast-signal-ingest','FAST_SIGNAL_READY','CONFIRM:${id}','fastSignalIngest: true','autoBuy:false']:
    if need not in s: raise SystemExit(f'missing {need}')
p.write_text(s,encoding='utf-8')
print('patched fast signal ingest + one-tap confirm')
